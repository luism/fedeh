        ...
        <p class="bg-info"><legend><strong>Editar</strong></legend></p>
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <?php echo Form::checkbox('donante', 'donante', isset($colaborador->donante) ? TRUE : FALSE) ?>
            </div>
          </div>
        </div><!-- Fin de fila -->
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <?php echo Form::input('tipo_documento', $colaborador->tipo_documento, array('class' => 'form-control', 'placeholder' => 'Tipo documento', 'autofocus', 'required' => '')) ?>
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group">
              <label for="nro_documento">Documento</label>
              <?php echo Form::input('nro_documento', $colaborador->nro_documento, array('class' => 'form-control', 'placeholder' => 'Numero de doc.', 'autofocus', 'required' => '')) ?>
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group">
