...
<html lang="en">
  <head>
    ...
    <![endif]-->
    <!-- Podemos cambiar los scripts online por locales:
      <script src="<?php echo URL::base('http').'assets/js/html5shiv.js' ?>"></script>
      <script src="<?php echo URL::base('http').'assets/js/respond.min.js' ?>"></script>
    -->
  </head>
